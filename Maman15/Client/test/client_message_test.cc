...
TEST_F(ClientMessageTest, upload_file) {
    ...
    string real{message.pack()};
    string expected{'\xbb', 'O', 'D', '`', '<', '%', '\x11', '\xed', '\xb2', '\xbb', '\xf2', '\xd2', '\r', '\xd2', 'D', '\x80', '\x03', 'O', '\x04', 'A', '\x01',
                    '\x00', '\x00', '\xbb', 'O', 'D', '`', '<', '%', '\x11', '\xed', '\xb2', '\xbb', '\xf2', '\xd2', '\r', '\xd2', 'D', '\x80', '.', '\x00', '\x00', '\x00', 'f', 'i', 'l', 'e', 'n', 'a', 'm', 'e', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
    ...
    ASSERT_EQ(expected, real);
    ASSERT_EQ(message.get_payload_size(), 255 + 4 + 46 + 16);
}

TEST_F(ClientMessageTest, file_crc_ok) {
    client::protocol::FileCRCOkMessage message{version, uuid, string{"filename"}};
    string real{message.pack()};
    string expected{'\xbb', 'O', 'D', '`', '<', '%', '\x11', '\xed', '\xb2', '\xbb', '\xf2', '\xd2', '\r', '\xd2', 'D', '\x80', '\x03', 'P',
                    '\x04', '\x0f', '\x01', '\x00', '\x00', '\xbb', 'O', 'D', '`', '<', '%', '\x11', '\xed', '\xb2', '\xbb', '\xf2', '\xd2', '\r', '\xd2', 'D', '\x80', 'f', 'i', 'l', 'e', 'n', 'a', 'm', 'e', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
                    '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
                    '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
                    '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
                    '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00', '\x00',
    ...
    ASSERT_EQ(expected, real);
    ASSERT_EQ(message.get_payload_size(), 16 + 255);
}

TEST_F(ClientMessageTest, crc_incorrect_will_retry) {
    client::protocol::CRCIncorrectWillRetry message{version, uuid, string{"filename"}};
    string real{message.pack()};
...
TEST_F(ClientMessageTest, crc_incorrect_giving_up) {
    client::protocol::CRCIncorrectGivingUp message{version, uuid, string{"filename"}};
    string real{message.pack()};
